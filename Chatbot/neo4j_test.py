...
class Neo4jKnowledgeBase(KnowledgeBase):
    ...
    def do_get_attributes_of_object(self, object_type) -> List[Text]:
        ...
        with self._driver.session(database='test') as session:
...
if __name__ == "__main__":
    ...
    #
    result = loop.run_until_complete(kb.get_objects("subtask", [], 5))
    print(result)

    # result = loop.run_until_complete(kb.get_object("subtask", "subtask_2"))
    # print(result)
