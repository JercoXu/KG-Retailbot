...
"""autogenerated by genpy from albert_skills/PickActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class PickActionFeedback(genpy.Message):
  ...
  _type = "albert_skills/PickActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','albert_skills/PickFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = albert_skills.msg.PickFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = albert_skills.msg.PickFeedback()
