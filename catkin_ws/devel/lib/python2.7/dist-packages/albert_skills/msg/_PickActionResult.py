...
"""autogenerated by genpy from albert_skills/PickActionResult.msg. Do not edit."""
import codecs
import sys
...
class PickActionResult(genpy.Message):
  ...
  _type = "albert_skills/PickActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','albert_skills/PickResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = albert_skills.msg.PickResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = albert_skills.msg.PickResult()
