...
"""autogenerated by genpy from albert_skills/LookForItemActionResult.msg. Do not edit."""
import codecs
import sys
...
class LookForItemActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "albert_skills/LookForItemActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','albert_skills/LookForItemResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LookForItemActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = albert_skills.msg.LookForItemResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = albert_skills.msg.LookForItemResult()
