...
"""autogenerated by genpy from albert_skills/LookForItemAction.msg. Do not edit."""
import codecs
import sys
...
import albert_skills.msg
import genpy
import std_msgs.msg

class LookForItemAction(genpy.Message):
  _md5sum = "6e35cd43ce85ff5b53c0a782c10af1d2"
  _type = "albert_skills/LookForItemAction"
...
"""
  ...
  _slot_types = ['albert_skills/LookForItemActionGoal','albert_skills/LookForItemActionResult','albert_skills/LookForItemActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LookForItemAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = albert_skills.msg.LookForItemActionGoal()
      if self.action_result is None:
        self.action_result = albert_skills.msg.LookForItemActionResult()
      if self.action_feedback is None:
        self.action_feedback = albert_skills.msg.LookForItemActionFeedback()
    else:
      self.action_goal = albert_skills.msg.LookForItemActionGoal()
      self.action_result = albert_skills.msg.LookForItemActionResult()
      self.action_feedback = albert_skills.msg.LookForItemActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.product_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_feedback.feedback.product_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.product_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.product_name = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_feedback.feedback.product_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_feedback.feedback.product_name = str[start:end]
      return self
