...
"""autogenerated by genpy from albert_skills/PlaceAction.msg. Do not edit."""
import codecs
import sys
...
class PlaceAction(genpy.Message):
  _md5sum = "acddfa5fb5a98fcea1a0f1142cc41b21"
  _type = "albert_skills/PlaceAction"
...
"""
  ...
  _slot_types = ['albert_skills/PlaceActionGoal','albert_skills/PlaceActionResult','albert_skills/PlaceActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = albert_skills.msg.PlaceActionGoal()
      if self.action_result is None:
        self.action_result = albert_skills.msg.PlaceActionResult()
      if self.action_feedback is None:
        self.action_feedback = albert_skills.msg.PlaceActionFeedback()
    else:
      self.action_goal = albert_skills.msg.PlaceActionGoal()
      self.action_result = albert_skills.msg.PlaceActionResult()
      self.action_feedback = albert_skills.msg.PlaceActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.goal_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.goal_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.goal_id = str[start:end]
      _x = self
      start = end
      end += 12
