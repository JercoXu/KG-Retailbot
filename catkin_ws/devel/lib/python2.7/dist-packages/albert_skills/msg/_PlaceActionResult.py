...
"""autogenerated by genpy from albert_skills/PlaceActionResult.msg. Do not edit."""
import codecs
import sys
...
class PlaceActionResult(genpy.Message):
  ...
  _type = "albert_skills/PlaceActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','albert_skills/PlaceResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = albert_skills.msg.PlaceResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = albert_skills.msg.PlaceResult()
