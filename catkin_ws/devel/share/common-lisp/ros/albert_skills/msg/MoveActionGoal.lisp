...
(cl:defclass <MoveActionGoal> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (goal
    :reader goal
    :initarg :goal
    :type albert_skills-msg:MoveGoal
    :initform (cl:make-instance 'albert_skills-msg:MoveGoal)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MoveActionGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveActionGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name albert_skills-msg:<MoveActionGoal> is deprecated: use albert_skills-msg:MoveActionGoal instead.")))
